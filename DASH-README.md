# This is the original dash readme that gets generated
# dash-composed
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> dash-composed -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import dash-composed to your layout, then run it:
